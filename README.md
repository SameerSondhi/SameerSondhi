# 💫 About Me:
Im a full stack software developer currently focusing on creating business logic (back end code) using Java and Python and interacting with databases such as MongoDB and MySQL. My go-to for front end is creating reusable components in React, and customizing with Bootstrap and Material UI. I currently volunteer as a Web Designer/Developer for Catalyze Silicon Valley, a non-profit connected with Code for San Jose.
